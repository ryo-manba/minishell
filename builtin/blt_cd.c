...
/*   Updated: 2021/09/27 10:34:40 by rmatsuka         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "ms_builtin.h"

static void	blt_cd_print_error(t_master *master, char *dirname, char *message)
{
...
static int	blt_cd_home(t_shellvar *env, t_master *master)
{
	t_shellvar	*home_pos;
...
static int	blt_cd_change_dir(t_shellvar *env, t_stree *tree, t_master *master)
{
	if (tree == NULL)
	{
